<template>
    <modal  :show = "show" @close="ChangeStateModal" >
        <div v-if="!paycheck">
            ...
            <div class="p-4 ">
                <button @click = "closeOrder" class="float-right p-2 text-white bg-green-400 rounded-sm hover:bg-green-500 ">Confirmar</button>
                    <button @click = "ChangeStateModalCloseButton" class="float-right p-2 mr-4 text-white bg-gray-400 rounded-sm hover:bg-gray-500">Cerrar</button>
