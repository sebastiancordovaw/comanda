<template>
    <modal  :show = "show" ><!--@close="ChangeStateModal">-->
            ...
            <div class="p-4 ">
                <button @click = "addRoom" class="float-right p-2 text-white bg-gray-800 rounded-sm hover:bg-gray-900">Confirmar</button>
                <button @click = "ChangeStateModalCloseButton" class="float-right p-2 mr-4 text-whte bg-cyan-300 rounded-sm hover:text-white hover:bg-cyan-400">Cerrar</button>
