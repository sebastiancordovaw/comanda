...
<div class="p-4 text-lg text-white bg-gray-800">
        ...
        <button :disabled="(productActivate)?false:true" @click="removeProduct" class="float-right p-2 mr-4 text-white bg-red-500 rounded-sm hover:text-gray-800 hover:bg-red-400">
