...
<div v-if="viewUpdateCategory">
    ...
    <div class="bg-derecho" style="height: 60vh;">
        <div class="grid grid-cols-12 p-4 pb-4 gap-y-2">
            ...
            <div class="col-span-12" v-if="!categories.length" >
                <input
            ...
            <div class="col-span-12" v-if="isSubCategory">
