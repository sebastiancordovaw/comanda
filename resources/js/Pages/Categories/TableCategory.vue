<template>
    <div class="p-4 text-lg text-white bg-gray-800">
        ...
        <button  @click="viewSort= !viewSort" class="float-right p-2 mr-3 bg-green-400 rounded-sm text-white hover:text-white hover:bg-green-300">
        ...
        <button @click="addCategory" class="float-right p-2 mr-3 text-gray-900 bg-gray-300 rounded-sm hover:text-white hover:bg-gray-400">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-3 h-3">
    ...
    <div class="relative overflow-x-auto shadow-md" style="min-height: 60vh;">
            ...
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        ...
                        <Dropdown align="left" width="100%" :contentClasses="['py-0']">
                            ...
                            <template #content>
                                <a  class="text-left hover:bg-yellow-300">
                                    ...
                                    <div class="grid grid-cols-12 px-2 py-2 hover:bg-gray-800 hover:text-white" @click.prevent = "filterQr(1)">
                                        <div class="col-span-9 cursor-pointer">Activo</div>
                                    </div>
                                    <div class="grid grid-cols-12 px-2 py-2 hover:bg-gray-800 hover:text-white" @click.prevent = "filterQr(0)">
                ...
                <tbody>
                    <template v-for="(category, i ) in categories" :key ="i">
                        <tr @click="edit(category)" :id="category.id" class="bg-white border-b cursor-pointer row dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600" v-if="(filterQrActive =='all')?1:(filterQrActive == category.qr)">
                        ...
                        <tr @click="edit(cat)" :id="cat.id" class="bg-white border-b cursor-pointer row dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600" v-if="(filterQrActive =='all')?1:(filterQrActive == cat.qr)">
                            <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
        ...
        <draggable v-model="categoriesSort" v-if="viewSort" @change="log">
            ...
            <div v-for="(category, i ) in categoriesSort" :key ="i" class="p-4 text-sm bg-white border-b cursor-move row dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600">
...
export default {
    setup(props,{emit}){
        ...
        const activate = (categoryEntry) =>{
            ...
            document.getElementById(row).classList.add("bg-cyan-200");
        }
